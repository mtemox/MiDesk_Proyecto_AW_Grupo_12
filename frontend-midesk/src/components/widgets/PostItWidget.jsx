...
const PostItWidget = () => {
    ...
    const FoldedCorner = () => (
        <div className={`absolute bottom-0 right-0 w-8 h-8 bg-gradient-to-br ${currentTheme.fold} rounded-tl-xl shadow-[-3px_-3px_5px_rgba(0,0,0,0.1)] dark:shadow-[-3px_-3px_5px_rgba(0,0,0,0.4)] pointer-events-none z-20`}></div>
    );
